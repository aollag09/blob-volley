...
/**
 * PROJET IPIPIP
 * Amaury Ollagnier CB1
 * =====================================================
 * <P>
 * Classe representant un graphique compose de courbes
 * @author Romu//Quelques modifications apportées par Amaury
 */
...
public class Graphique extends Frame {
	...
	public final static int X_MIN_PICXEL = 28;
	public final static int X_MAX_PICXEL = 987;
	public final static int Y_MIN_PICXEL = 50;
	public final static int Y_MAX_PICXEL = 560;
	...
	/**
	 * les bornes de la partie observable fixées par l'utilisateur.
	 */
	...
	/**
	 * Setteur permettant à l'utilisateur de modifier la varible d'instance lesCourbes
	 * @param ArrayList<Courbe> Contenant les nouvelles courbes du graphique
	 * @return void, modifie les courbes du graphique
	 */
	public void setLesCourbes(ArrayList<Courbe> lesNouvellesCourbes){
		this.lesCourbes = lesNouvellesCourbes;
	}
	/** 
	...
	/**
	 * @return l'abscisse maximale du graphique
	 */
	...
	/**
	 * @return l'abscisse minimale du graphique
	 */
	...
	/**
	 * @return l'ordonnée maximale du graphique
	 */
	...
	/**
	 * @return l'ordonnée minimale du graphique
	 */
	...
	public double getMaxYU(){
		return this.maxYU;
	}
	
	public double getMinYU(){
		return this.minYU;
	}
	...
	/**
	 * @return L'ArrayList contenant toutes les courbes du graphique
	 */
	public ArrayList<Courbe> getCourbes (){
		return this.lesCourbes;
	}
	/**
	...
	public void paint(Graphics g) {
		...
		if (this.getCourbe(0)!=null) {
			if (this.image==null) {
				this.image = createImage ( this.largeur, this.hauteur);
			...
			for (int i=0; i<this.nbCourbes(); i++) {
				c = this.getCourbe(i);
				for (int j=0; j<c.getNombrePoints(); j++) {
			...
			int nbLignes = 1;//this.nbCourbes()/nbTitresParligne;
			...
			for (int i=0; i<this.nbCourbes(); i++) {
				...
				c = this.getCourbe(i);
				for (int j=0; j<c.getNombrePoints()-1; j++) {
	...
	/*public static void main(String[] parametresLigneCommande) {
		...
		Graphique g=new GraphiqueBezier("Essai",800,600);
		Courbe c;
		...
		Graphique g2=new GraphiqueBezier("Testons", 640, 480);
