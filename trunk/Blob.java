...
public class Blob {
	...
	/** the color */
	public static Color BLOB_SERVEUR_COLOR = new Color(166,73,164);
	public static Color BLOB_CLIENT_COLOR = new Color(238, 27, 34);
	...
	public void paintBlob(Graphics g){
		...
		if(!this.isServeur)
			signe = -1;
		/*g.fillOval((int) (positionX+ signe*positionX/6),
